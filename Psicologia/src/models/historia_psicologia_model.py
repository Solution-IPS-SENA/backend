...
class HistoriaPsicologia(db.Model):
    ...
    ries_emp_cond = db.Column(db.String(2), nullable=False, default=anexos.MEDIO_AMBIENTE[0])
    ries_emp_carga = db.Column(db.String(2), nullable=False, default=anexos.CARGA[0])
