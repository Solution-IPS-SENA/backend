...
from src.validators.historia_optometria_validator import HistoriaOptometriaSchema
from src.services.historia_optometria_service import HistoriaOptometriaService
from flask.views import MethodView

class HistoriaOptometriaController(MethodView):

    def __init__(self):
        self.validator = HistoriaOptometriaSchema()
        self.service = HistoriaOptometriaService()
