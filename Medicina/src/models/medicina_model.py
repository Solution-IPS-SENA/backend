...
class HistoriaMedica(db.Model):
    ...
    ant_padre_card = db.Column(db.String(50), nullable=False, default="N/A")
    ant_madre_card = db.Column(db.String(50), nullable=False, default="N/A")
    ant_padre_cong = db.Column(db.String(50), nullable=False, default="N/A")
    ant_madre_cong = db.Column(db.String(50), nullable=False, default="N/A")
    ant_per_pato = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    ant_per_qui = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    ant_per_trau = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    ant_per_toxi = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    ant_per_alergi = db.Column(db.String(10), nullable=False, default="No refiere")
    ant_per_ets = db.Column(db.String(100), nullable=False, default="NO REFIERE")
    ...
    ant_per_gin_plan = db.Column(db.String(2), nullable=False, default="NO")
    ant_per_gin_dism = db.Column(db.String(2), nullable=False, default="NO")
    ant_per_gin_disp = db.Column(db.String(2), nullable=False, default="NO")
    ant_per_gin_mam = db.Column(db.DateTime(), nullable=False, default="0000-00-00")
    ant_per_gin_mens = db.Column(db.String(7), nullable=False, default="NORMAL")
    ant_per_obs2 = db.Column(db.String(500), nullable=False, default="")
    inm_hep_a = db.Column(db.String(8), nullable=False, default="N/A")
    inm_hep_b = db.Column(db.String(8), nullable=False, default="N/A")
    inm_trip = db.Column(db.String(8), nullable=False, default="N/A")
    inm_teta = db.Column(db.String(8), nullable=False, default="N/A")
    inm_mala = db.Column(db.String(8), nullable=False, default="N/A")
    inm_amar = db.Column(db.String(8), nullable=False, default="N/A")
    inm_tifo = db.Column(db.String(8), nullable=False, default="N/A")
    inm_cov = db.Column(db.String(8), nullable=False, default="N/A")
    mani_ali = db.Column(db.DateTime(), nullable=False, default="0000-00-00")
    inm_obs = db.Column(db.String(500), nullable=False, default="")
    hab_ciga = db.Column(db.String(2), nullable=False, default="NO")
    hab_alco = db.Column(db.String(2), nullable=False, default="NO")
    hab_drog = db.Column(db.String(2), nullable=False, default="NO")
    hab_dep = db.Column(db.String(2), nullable=False, default="NO")
    hab_les = db.Column(db.String(2), nullable=False, default="NO")    
    hab_obs = db.Column(db.String(500), nullable=False, default="")
    sis_derma = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_ost_musc = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_ost_arti = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_geni = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_meta = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_neur = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_carf = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_endo = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_uro = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_gatro = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    sis_orl = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_fis_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_fis_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_fis_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_fis_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_bio_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_bio_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_bio_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_bio_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_quim_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_quim_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_quim_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_quim_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_seg_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_seg_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_seg_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_seg_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_biom_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_biom_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_biom_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_biom_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_psico_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_psico_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_psico_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_psico_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_exp_obs = db.Column(db.String(500), nullable=False, default="")
    rie_ant_fis_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_fis_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_fis_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_fis_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_bio_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_bio_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_bio_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_bio_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_quim_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_quim_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_quim_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_quim_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_seg_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_seg_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_seg_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_seg_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_biom_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_biom_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_biom_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_biom_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_psico_1 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_psico_2 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_psico_3 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_psico_4 = db.Column(db.String(10), nullable=False, default="NO REFIERE")
    rie_ant_obs = db.Column(db.String(500), nullable=False, default="")
    ocu_equi = db.Column(db.String(22), nullable=False, default="N/A")
    ocu_acti = db.Column(db.String(100), nullable=False, default="N/A")
    ...
    cie_concep_fin = db.Column(db.String(12), nullable=False, default="APROBADO")
