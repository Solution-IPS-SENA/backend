...
class HistoriaMedica(db.Model):
    ...
    ant_per_pato = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    ant_per_qui = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    ...
    ant_per_ets = db.Column(db.String(100), nullable=False, default=anexos.REFERENCIA[0])
    ...
    rie_exp_fis_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_fis_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_fis_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_fis_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_bio_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_bio_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_bio_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_bio_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_quim_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_quim_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_quim_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_quim_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_seg_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_seg_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_seg_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_seg_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_biom_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_biom_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_biom_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_biom_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_psico_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_psico_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_psico_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_psico_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_exp_obs = db.Column(db.String(500), nullable=False, default="")
    rie_ant_fis_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_fis_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_fis_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_fis_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_bio_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_bio_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_bio_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_bio_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_quim_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_quim_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_quim_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_quim_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_seg_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_seg_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_seg_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_seg_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_biom_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_biom_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_biom_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_biom_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_psico_1 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_psico_2 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_psico_3 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
    rie_ant_psico_4 = db.Column(db.String(10), nullable=False, default=anexos.REFERENCIA[0])
