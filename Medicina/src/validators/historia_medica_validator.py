...
class HistoriaMedicaSchema(Schema):
    ...
    ant_per_qui = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    ...
    rie_exp_fis_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_fis_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_fis_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_fis_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_bio_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_bio_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_bio_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_bio_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_quim_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_quim_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_quim_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_quim_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_seg_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_seg_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_seg_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_seg_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_biom_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_biom_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_biom_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_biom_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_psico_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_psico_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_psico_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_psico_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_exp_obs = fields.Str(required=True, validate=validate.Length(max=500))
    rie_ant_fis_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_fis_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_fis_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_fis_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_bio_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_bio_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_bio_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_bio_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_quim_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_quim_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_quim_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_quim_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_seg_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_seg_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_seg_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_seg_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_biom_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_biom_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_biom_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_biom_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_psico_1 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_psico_2 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_psico_3 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
    rie_ant_psico_4 = fields.Str(required=True, validate=lambda x: x in a.REFERENCIA)
